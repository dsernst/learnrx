Array.prototype.concatMap = require('./concatMap');
Array.prototype.concatMap = require('./concatMap');
      ...
      videos: videos.filter(function (video) {
        ...
        return {
          ...
          boxart: boxarts.filter(function (boxart) {
            ...
            if ((boxart.width * boxart.height) < (memo.width * memo.height)) {
              return boxart;
            }
            return memo;
          }).url
...
console.log(require('util').inspect(exercise(), {depth: null}));

// [Not quite there, need to flatten the time down without using [0].]
